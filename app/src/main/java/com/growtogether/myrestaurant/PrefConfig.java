...
public class PrefConfig {
    ...
    public void writeLoginStatus(boolean status){
        ...
        editor.putBoolean(context.getString(R.string.pref_lgoin_status), status);
        editor.commit();
    }

    public boolean readLoginStatus(){
        return sharedPreferences.getBoolean(context.getString(R.string.pref_lgoin_status), false);
    }
